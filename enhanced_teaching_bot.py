...
class GoogleSheetsManager:
    ...
    def save_conversation_to_sheets(self, conversation_data: Dict):
        ...
        if not self.conversations_worksheet:
            return False
...
class DatabaseManager:
    """Enhanced database manager with new user fields"""
    ...
    def init_database(self):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            # Create analytics table (unchanged)
            cursor.execute('''
        ...
        try:
            with self.get_connection() as conn:
                ...
                if exists:
                    ...
                    # Create new user
                    fields = ['chat_id', 'first_interaction', 'total_messages']
                    values = [chat_id, True, 1]
...
def health_check():
    ...
    try:
        ...
        sheets_status = "connected" if sheets_manager.gc else "not connected"
...
if __name__ == "__main__":
    ...
    logger.info(f"Google Sheets: {'Configured' if sheets_manager.gc else 'Not Configured'}")
